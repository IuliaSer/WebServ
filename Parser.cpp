...
void Request::parse_request(std::string str)
{
    _buf += str;
    _len = _buf.length();
    int found = _buf.find("\r\n\r\n");
...
//     zapros.parse_request("get hello hpp01.20\r\nhost: iulia\r\nkomp: 15\r\nchtoto: 88\r\nTransfer-Encoding: chunked\r\n\r\n5\r\n12345\r\n3\r\n123\r\n4\r\n1234\r\n0\r\n\r\nhernya");

//     // zapros.parse_request("get hello hpp01.20\r\nhost: iulia\r\nkomp: 15\r\n");
//     // zapros.parse_request("chtoto: 88\r\n");
//     // zapros.parse_request("Transfer-Encoding: chunked\r\n\r\n");
//     // zapros.parse_request("5\r\n12345\r\n3\r\n123\r\n4\r\n1234\r\n0\r\n\r\nhernya");
//     std::cout << zapros._method << std::endl;
//     std::cout << zapros._resource_name << std::endl;
//     std::cout << zapros._protocol_version << std::endl;
//     std::map<std::string, std::string>::iterator it;
// 	for (it = zapros._headers.begin(); it != zapros._headers.end(); it++)
//     {
//         std::cout << "key: " << it->first << std::endl;
//         std::cout << "val: " << it->second << std::endl;
//     }
//     std::cout << zapros._body << std::endl;
// }